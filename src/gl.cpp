...
template <typename T>
T* get_vector(value data, value offset) {
    char* dat = (char*)(((Vector*)val_data(data))->dat);
    dat += val_get<int>(offset);
    return (T*)dat;
}

GLuint* copy_uints(value ints) {
    GLuint* buf = new GLuint[val_array_size(ints)];
    for (int i = 0; i < val_array_size(ints); i++)
        buf[i] = val_get<int>(val_array_i(ints, i));
    return buf;
}
GLint* copy_ints(value ints) {
    return (GLint*)copy_uints(ints);
}
GLenum* copy_enum(value ints) {
    return (GLenum*)copy_uints(ints);
}

void copy_del_uints(value ints, GLuint* cints, int n) {
    val_array_set_size(ints, n);
    for (int i = 0; i < n; i++)
        val_array_set_i(ints, i, alloc<int>(cints[i]));
    delete[] cints;
}
void copy_del_ints(value ints, GLint* cints, int n) {
    copy_del_uints(ints, (GLuint*)cints, n);
}
...
value hx_gl_vector_get_short(value data, value offset, value i) {
    short* dat = get_vector<short>(data, offset);
    return alloc<int>(dat[val_get<int>(i)]);
}
value hx_gl_vector_get_int(value data, value offset, value i) {
    int* dat = get_vector<int>(data, offset);
    return alloc<int>(dat[val_get<int>(i)]);
}
value hx_gl_vector_get_float(value data, value offset, value i) {
    float* dat = get_vector<float>(data, offset);
    return alloc<float>(dat[val_get<int>(i)]);
}
value hx_gl_vector_get_double(value data, value offset, value i) {
    double* dat = get_vector<double>(data, offset);
    return alloc<double>(dat[val_get<int>(i)]);
}
DEFINE_PRIM(hx_gl_vector_get_byte,   3)
DEFINE_PRIM(hx_gl_vector_get_short,  3)
DEFINE_PRIM(hx_gl_vector_get_int,    3)
DEFINE_PRIM(hx_gl_vector_get_float,  3)
DEFINE_PRIM(hx_gl_vector_get_double, 3)

value hx_gl_vector_set_byte(value data, value offset, value i, value x) {
    char* dat = get_vector<char>(data, offset);
    return alloc<int>(dat[val_get<int>(i)] = val_get<int>(x));
}
value hx_gl_vector_set_short(value data, value offset, value i, value x) {
    short* dat = get_vector<short>(data, offset);
    return alloc<int>(dat[val_get<int>(i)] = val_get<int>(x));
}
value hx_gl_vector_set_int(value data, value offset, value i, value x) {
    int* dat = get_vector<int>(data, offset);
    return alloc<int>(dat[val_get<int>(i)] = val_get<int>(x));
}
value hx_gl_vector_set_float(value data, value offset, value i, value x) {
    float* dat = get_vector<float>(data, offset);
    return alloc<float>(dat[val_get<int>(i)] = val_get<float>(x));
}
value hx_gl_vector_set_double(value data, value offset, value i, value x) {
    double* dat = get_vector<double>(data, offset);
    return alloc<double>(dat[val_get<int>(i)] = val_get<double>(x));
}
DEFINE_PRIM(hx_gl_vector_set_byte,   4)
DEFINE_PRIM(hx_gl_vector_set_short,  4)
DEFINE_PRIM(hx_gl_vector_set_int,    4)
DEFINE_PRIM(hx_gl_vector_set_float,  4)
DEFINE_PRIM(hx_gl_vector_set_double, 4)

void finalise_vector(value v) {
    Vector* dat = (Vector*)val_data(v);
    free(dat->dat);
}
value vector_array(value arr, int T) {
    ...
    vec->dat = dat;
    vec->size = j * byte_size(T);
    value v = alloc_abstract(k_Vector, vec);
    val_gc(v, finalise_vector);
    return v;
}

value hx_gl_allocVector(value type, value count) {
...
value hx_gl_createVector(value arr, value type) {
    return vector_array(arr, val_get<int>(type));
}
value hx_gl_dataVector(value data, value size) {
    const char* buf;
...
DEFINE_PRIM(hx_gl_createVector, 2);
DEFINE_PRIM(hx_gl_arrvector_resize, 2);
DEFINE_PRIM(hx_gl_dataVector, 2);
...
// A
// ================================================================================================
value hx_gl_activeTexture(value texture) {
    glActiveTexture(val_get<int>(texture));
    return val_null;
}
value hx_gl_attachShader(value program, value shader) {
...
value hx_gl_bufferData(value target, value size, value data, value dataOffset, value usage) {
    glBufferData(val_get<int>(target), val_get<int>(size), get_vector<GLvoid>(data, dataOffset), val_get<int>(usage));
    return val_null;
}
value hx_gl_bufferSubData(value target, value offset, value size, value data, value dataOffset) {
    glBufferSubData(val_get<int>(target), val_get<int>(offset), val_get<int>(size), get_vector<GLvoid>(data, dataOffset));
    return val_null;
}
...
value hx_gl_clampColor(value target, value clamp) {
    glClampColor(val_get<int>(target), val_get<int>(clamp));
    return val_null;
}
value hx_gl_clear(value mask) {
    glClear(val_get<int>(mask));
    return val_null;
}
value hx_gl_clearBufferiv(value _buffer, value drawBuffer, value _value) {
    GLint* buf = copy_ints(_value);
    glClearBufferiv(val_get<int>(_buffer), val_get<int>(drawBuffer), buf);
    delete [] buf;
    return val_null;
}
value hx_gl_clearBufferuiv(value _buffer, value drawBuffer, value _value) {
    GLuint* buf = copy_uints(_value);
    glClearBufferuiv(val_get<int>(_buffer), val_get<int>(drawBuffer), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_clearBufferfv(value _buffer, value drawBuffer, value _value, value byteOffset) {
    glClearBufferfv(val_get<int>(_buffer), val_get<int>(drawBuffer), get_vector<GLfloat>(_value, byteOffset));
    return val_null;
}
value hx_gl_clearBufferfi(value _buffer, value drawBuffer, value depth, value stencil) {
    glClearBufferfi(val_get<int>(_buffer), val_get<int>(drawBuffer), val_get<double>(depth), val_get<int>(stencil));
    return val_null;
}
value hx_gl_clearColor(value r, value g, value b, value a) {
    glClearColor(val_get<float>(r), val_get<float>(g), val_get<float>(b), val_get<float>(a));
    return val_null;
}
value hx_gl_clearDepth(value depth) {
    glClearDepth(val_get<double>(depth));
    return val_null;
}
value hx_gl_clearStencil(value stencil) {
...
value hx_gl_colorMask(value r, value g, value b, value a) {
    glColorMask(val_get<bool>(r), val_get<bool>(g), val_get<bool>(b), val_get<bool>(a));
    return val_null;
}
value hx_gl_colorMaski(value buf, value r, value g, value b, value a) {
...
value hx_gl_compressedTexImage1D(value* args, int nargs) {
    glCompressedTexImage1D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), get_vector<GLvoid>(args[6], args[7]));
    return val_null;
}
value hx_gl_compressedTexImage2D(value* args, int nargs) {
    glCompressedTexImage2D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), val_get<int>(args[6]), get_vector<GLvoid>(args[7], args[8]));
    return val_null;
}
value hx_gl_compressedTexImage3D(value* args, int nargs) {
    glCompressedTexImage3D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), val_get<int>(args[6]), val_get<int>(args[7]), get_vector<GLvoid>(args[8], args[9]));
    return val_null;
}
value hx_gl_compressedTexSubImage1D(value* args, int nargs) {
    glCompressedTexSubImage1D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), get_vector<GLvoid>(args[6], args[7]));
    return val_null;
}
value hx_gl_compressedTexSubImage2D(value* args, int nargs) {
    glCompressedTexSubImage2D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), val_get<int>(args[6]), val_get<int>(args[7]), get_vector<GLvoid>(args[8], args[9]));
    return val_null;
}
value hx_gl_compressedTexSubImage3D(value* args, int nargs) {
    glCompressedTexSubImage3D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), val_get<int>(args[6]), val_get<int>(args[7]), val_get<int>(args[8]), val_get<int>(args[9]), get_vector<GLvoid>(args[10], args[11]));
    return val_null;
}
value hx_gl_copyBufferSubData(value readt, value writet, value reado, value writeo, value size) {
    glCopyBufferSubData(val_get<int>(readt), val_get<int>(writet), val_get<int>(reado), val_get<int>(writeo), val_get<int>(size));
    return val_null;
}
value hx_gl_copyTexImage1D(value* args, int nargs) {
...
value hx_gl_copyTexImage2D(value* args, int nargs) {
...
value hx_gl_copyTexSubImage1D(value* args, int nargs) {
...
value hx_gl_copyTexSubImage2D(value* args, int nargs) {
...
value hx_gl_copyTexSubImage3D(value* args, int nargs) {
...
value hx_gl_cullFace(value mode) {
...
// D
// ================================================================================================
value hx_gl_deleteBuffers(value buffers) {
    GLuint* buf = copy_uints(buffers);
    glDeleteBuffers(val_array_size(buffers), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_deleteFramebuffers(value buffers) {
    GLuint* buf = copy_uints(buffers);
    glDeleteFramebuffers(val_array_size(buffers), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_deleteProgram(value program) {
    glDeleteProgram(val_get<int>(program));
    return val_null;
}
value hx_gl_deleteQueries(value queries) {
    GLuint* buf = copy_uints(queries);
    glDeleteQueries(val_array_size(queries), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_deleteRenderbuffers(value buffers) {
    GLuint* buf = copy_uints(buffers);
    glDeleteRenderbuffers(val_array_size(buffers), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_deleteSamplers(value samplers) {
    GLuint* buf = copy_uints(samplers);
    glDeleteSamplers(val_array_size(samplers), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_deleteShader(value shader) {
    glDeleteShader(val_get<int>(shader));
    return val_null;
}
value hx_gl_deleteSync(value sync) {
    val_check_kind(sync, k_Sync);
    glDeleteSync((GLsync)val_data(sync));
    return val_null;
}
value hx_gl_deleteTextures(value textures) {
    GLuint* buf = copy_uints(textures);
    glDeleteTextures(val_array_size(textures), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_deleteVertexArrays(value vertexArrays) {
    GLuint* buf = copy_uints(vertexArrays);
    glDeleteVertexArrays(val_array_size(vertexArrays), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_depthFunc(value func) {
    glDepthFunc(val_get<int>(func));
    return val_null;
}
value hx_gl_depthMask(value flag) {
    glDepthMask(val_get<bool>(flag));
    return val_null;
}
value hx_gl_depthRange(value near, value far) {
    glDepthRange(val_get<double>(near), val_get<double>(far));
    return val_null;
}
value hx_gl_detachShader(value program, value shader) {
    glDetachShader(val_get<int>(program), val_get<int>(shader));
    return val_null;
}
value hx_gl_disable(value flag) {
    glDisable(val_get<int>(flag));
    return val_null;
}
value hx_gl_disableVertexAttribArray(value index) {
    glDisableVertexAttribArray(val_get<int>(index));
    return val_null;
}
value hx_gl_disablei(value cap, value index) {
    glDisablei(val_get<int>(cap), val_get<int>(index));
    return val_null;
}
value hx_gl_drawArrays(value mode, value first, value count) {
    glDrawArrays(val_get<int>(mode), val_get<int>(first), val_get<int>(count));
    return val_null;
}
value hx_gl_drawArraysInstanced(value mode, value first, value count, value primcount) {
    glDrawArraysInstanced(val_get<int>(mode), val_get<int>(first), val_get<int>(count), val_get<int>(primcount));
    return val_null;
}
value hx_gl_drawBuffer(value mode) {
    glDrawBuffer(val_get<int>(mode));
    return val_null;
}
value hx_gl_drawBuffers(value bufs) {
    GLenum* buf = copy_enum(bufs);
    glDrawBuffers(val_array_size(bufs), buf);
    delete[] buf;
    return val_null;
}
value hx_gl_drawElements(value mode, value count, value type, value indices, value byteOffset) {
    glDrawElements(val_get<int>(mode), val_get<int>(count), val_get<int>(type), get_vector<GLvoid>(indices, byteOffset));
    return val_null;
}
value hx_gl_drawElementsBaseVertex(value* args, int narg) {
    glDrawElementsBaseVertex(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), get_vector<GLvoid>(args[3], args[4]), val_get<int>(args[5]));
    return val_null;
}
value hx_gl_drawElementsInstanced(value* args, int narg) {
    glDrawElementsInstanced(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), get_vector<GLvoid>(args[3], args[4]), val_get<int>(args[5]));
    return val_null;
}
value hx_gl_drawElementsInstancedBaseVertex(value* args, int nargs) {
    glDrawElementsInstancedBaseVertex(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), get_vector<GLvoid>(args[3], args[4]), val_get<int>(args[5]), val_get<int>(args[6]));
    return val_null;
}
value hx_gl_drawRangeElements(value* args, int nargs) {
    glDrawRangeElements(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), get_vector<GLvoid>(args[5], args[6]));
    return val_null;
}
value hx_gl_drawRangeElementsBaseVertex(value* args, int nargs) {
    glDrawRangeElementsBaseVertex(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), get_vector<GLvoid>(args[5], args[6]), val_get<int>(args[7]));
    return val_null;
}
...
// E
// ================================================================================================
value hx_gl_enable(value cap) {
    glEnable(val_get<int>(cap));
    return val_null;
}
value hx_gl_enableVertexAttribArray(value index) {
    glEnableVertexAttribArray(val_get<int>(index));
    return val_null;
}
value hx_gl_enablei(value cap, value index) {
    glEnablei(val_get<int>(cap), val_get<int>(index));
    return val_null;
}
value hx_gl_endConditionalRender() {
    glEndConditionalRender();
    return val_null;
}
value hx_gl_endQuery(value target) {
    glEndQuery(val_get<int>(target));
    return val_null;
}
value hx_gl_endTransformFeedback() {
...
// F
// ================================================================================================
value hx_gl_fenceSync(value condition, value flags) {
...
value hx_gl_framebufferTextureLayer(value target, value att, value texture, value level, value layer) {
    glFramebufferTextureLayer(val_get<int>(target), val_get<int>(att), val_get<int>(texture), val_get<int>(level), val_get<int>(layer));
    return val_null;
}
value hx_gl_frontFace(value mode) {
...
// G
// ================================================================================================
value hx_gl_genBuffers(value n, value buffers) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenBuffers(val_get<int>(n), buf);
    copy_del_uints(buffers, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_genFramebuffers(value n, value buffers) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenFramebuffers(val_get<int>(n), buf);
    copy_del_uints(buffers, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_genQueries(value n, value queries) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenQueries(val_get<int>(n), buf);
    copy_del_uints(queries, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_genRenderbuffers(value n, value buffers) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenRenderbuffers(val_get<int>(n), buf);
    copy_del_uints(buffers, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_genSamplers(value n, value samplers) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenSamplers(val_get<int>(n), buf);
    copy_del_uints(samplers, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_genTextures(value n, value arrays) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenTextures(val_get<int>(n), buf);
    copy_del_uints(arrays, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_genVertexArrays(value n, value arrays) {
    GLuint* buf = new GLuint[val_get<int>(n)];
    glGenVertexArrays(val_get<int>(n), buf);
    copy_del_uints(arrays, buf, val_get<int>(n));
    return val_null;
}
value hx_gl_generateMipmap(value target) {
...
#define GLGETV(N,T,G) \
    value hx_gl_get##N##v(value pname, value outparams) { \
...
value hx_gl_getInteger64v(value pname, value outparams) {
    int count = glGetICount(pname);
...
#define GLGETIV(N,T,G) \
    value hx_gl_get##N##i_v(value pname, value index, value outparams) { \
        int count = glGetICount(pname); \
        G* params = new G[count]; \
        val_array_set_size(outparams, count); \
...
value hx_gl_getInteger64i_v(value pname, value index, value outparams) {
    int count = glGetICount(pname);
    GLint64* params = new GLint64[count];
    val_array_set_size(outparams, count*2);
...
value hx_gl_getActiveUniformsiv(value program, value uniforms, value pname, value params) {
    val_array_set_size(params, val_array_size(uniforms));
    GLuint* buf = copy_uints(uniforms);
    GLint* pbuf = new GLint[val_array_size(uniforms)];
    glGetActiveUniformsiv(val_get<int>(program), val_array_size(uniforms), buf, val_get<int>(pname), pbuf);
    copy_del_ints(params, pbuf, val_array_size(uniforms));
    delete[] buf;
    return val_null;
}
value hx_gl_getAttachedShaders(value program, value ret) {
...
value hx_gl_getBufferSubData(value target, value offset, value size, value data, value byteOffset) {
    glGetBufferSubData(val_get<int>(target), val_get<int>(offset), val_get<int>(size), get_vector<GLvoid>(data, byteOffset));
    return val_null;
}
value hx_gl_getCompressedTexImage(value target, value lod, value img, value byteOffset) {
    glGetCompressedTexImage(val_get<int>(target), val_get<int>(lod), get_vector<GLvoid>(img, byteOffset));
    return val_null;
}
...
value hx_gl_getQueryObjecti64v(value id, value pname, value out) {
    GLint64 ret;
...
value hx_gl_getQueryObjectui64v(value id, value pname, value out) {
    GLuint64 ret;
...
value hx_gl_getTexImage(value* args, int narg) {
    glGetTexImage(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), get_vector<GLvoid>(args[4], args[5]));
    return val_null;
}
...
value hx_gl_getUniformIndices(value program, value names, value indices) {
    ...
    GLuint* buf = copy_uints(indices);
    glGetUniformIndices(val_get<int>(program), cnt, cnames, buf);
    copy_del_uints(indices, buf, val_array_size(indices));
    delete[] cnames;
    return indices;
}
...
// H
// ================================================================================================
value hx_gl_hint(value target, value mode) {
...
// L
// ================================================================================================
value hx_gl_lineWidth(value width) {
...
// M
// ================================================================================================
value hx_gl_multiDrawArrays(value mode, value first, value count) {
    GLint* buf1 = copy_ints(first);
    GLint* buf2 = copy_ints(count);
    glMultiDrawArrays(val_get<int>(mode), buf1, buf2, val_array_size(first));
    delete[] buf1;
    delete[] buf2;
    return val_null;
}
value hx_gl_multiDrawElements(value mode, value count, value type, value indices, value byteOffsets) {
    int cnt = val_array_size(indices);
    const GLvoid** cindices = new const GLvoid*[cnt];
    for (int i = 0; i < cnt; i++) cindices[i] = get_vector<GLvoid>(val_array_i(indices, i), val_array_i(byteOffsets, i));
    GLsizei* buf = (GLsizei*)copy_uints(count);
    glMultiDrawElements(val_get<int>(mode), buf, val_get<int>(type), cindices, cnt);
    delete[] buf;
    delete[] cindices;
    return val_null;
}
value hx_gl_multiDrawElementsBaseVertex(value* args, int narg) {
    int cnt = val_array_size(args[3]);
    GLvoid** cindices = new GLvoid*[cnt];
    for (int i = 0; i < cnt; i++) cindices[i] = get_vector<GLvoid>(val_array_i(args[3], i), val_array_i(args[4], i));
    GLint* buf1 = copy_ints(args[1]);
    GLint* buf2 = copy_ints(args[5]);
    glMultiDrawElementsBaseVertex(val_get<int>(args[0]), buf1, val_get<int>(args[2]), cindices, cnt, buf2);
    delete[] buf1;
    delete[] buf2;
    delete[] cindices;
    return val_null;
...
// P
// ================================================================================================
value hx_gl_pixelStoref(value pname, value param) {
    glPixelStoref(val_get<int>(pname), val_get<double>(param));
    return val_null;
}
value hx_gl_pixelStorei(value pname, value param) {
    glPixelStorei(val_get<int>(pname), val_get<int>(param));
    return val_null;
}
value hx_gl_pointParameterf(value pname, value param) {
    glPixelStoref(val_get<int>(pname), val_get<double>(param));
    return val_null;
}
value hx_gl_pointParameteri(value pname, value param) {
    glPixelStorei(val_get<int>(pname), val_get<int>(param));
    return val_null;
}
value hx_gl_pointSize(value size) {
    glPointSize(val_get<double>(size));
    return val_null;
}
value hx_gl_polygonMode(value face, value mode) {
    glPolygonMode(val_get<int>(face), val_get<int>(mode));
    return val_null;
}
value hx_gl_polygonOffset(value factor, value units) {
    glPolygonOffset(val_get<double>(factor), val_get<double>(units));
    return val_null;
}
value hx_gl_primitiveRestartIndex(value index) {
    glPrimitiveRestartIndex(val_get<int>(index));
    return val_null;
}
value hx_gl_provokingVertex(value provokeMode) {
...
// Q
// ================================================================================================
value hx_gl_queryCounter(value id, value target) {
...
// R
// ================================================================================================
value hx_gl_readBuffer(value mode) {
    glReadBuffer(val_get<int>(mode));
    return val_null;
}
value hx_gl_readPixels(value* args, int nargs) {
    glReadPixels(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), get_vector<GLvoid>(args[6], args[7]));
    return val_null;
}
value hx_gl_renderbufferStorage(value target, value internalFormat, value width, value height) {
    glRenderbufferStorage(val_get<int>(target), val_get<int>(internalFormat), val_get<int>(width), val_get<int>(height));
    return val_null;
}
value hx_gl_renderbufferStorageMultisample(value target, value samples, value internalFormat, value width, value height) {
...
// S
// ================================================================================================
value hx_gl_sampleCoverage(value val, value invert) {
    glSampleCoverage(val_get<double>(val), val_get<bool>(invert));
    return val_null;
}
value hx_gl_sampleMaski(value maskn, value mask) {
    glSampleMaski(val_get<int>(maskn), val_get<int>(mask));
    return val_null;
}
value hx_gl_samplerParameterf(value sampler, value pname, value param) {
    glSamplerParameterf(val_get<int>(sampler), val_get<int>(pname), val_get<double>(param));
    return val_null;
}
value hx_gl_samplerParameteri(value sampler, value pname, value param) {
    glSamplerParameteri(val_get<int>(sampler), val_get<int>(pname), val_get<int>(param));
    return val_null;
}
value hx_gl_scissor(value x, value y, value width, value height) {
    glScissor(val_get<int>(x), val_get<int>(y), val_get<int>(width), val_get<int>(height));
    return val_null;
}
value hx_gl_shaderSource(value shader, value strings) {
...
value hx_gl_stencilFunc(value func, value ref, value mask) {
    glStencilFunc(val_get<int>(func), val_get<int>(ref), val_get<int>(mask));
    return val_null;
}
value hx_gl_stencilFuncSeparate(value face, value func, value ref, value mask) {
    glStencilFuncSeparate(val_get<int>(face), val_get<int>(func), val_get<int>(ref), val_get<int>(mask));
    return val_null;
}
value hx_gl_stencilMask(value mask) {
    glStencilMask(val_get<int>(mask));
    return val_null;
}
value hx_gl_stencilMaskSeparate(value face, value mask) {
    glStencilMaskSeparate(val_get<int>(face), val_get<int>(mask));
    return val_null;
}
value hx_gl_stencilOp(value sfail, value dpfail, value dppass) {
    glStencilOp(val_get<int>(sfail), val_get<int>(dpfail), val_get<int>(dppass));
    return val_null;
}
value hx_gl_stencilOpSeparate(value face, value sfail, value dpfail, value dppass) {
...
// T
// ================================================================================================
value hx_gl_texBuffer(value target, value format, value buf) {
    glTexBuffer(val_get<int>(target), val_get<int>(format), val_get<int>(buf));
    return val_null;
}
value hx_gl_texImage1D(value* args, int narg) {
    void* data = NULL;
    value buf = args[7];
    if (!val_is_null(buf)) data = get_vector<GLvoid>(buf, args[8]);
...
value hx_gl_texImage2D(value* args, int narg) {
    void* data = NULL;
    value buf = args[8];
    if (!val_is_null(buf)) data = get_vector<GLvoid>(buf, args[9]);
...
value hx_gl_texImage2DMultisample(value* args, int narg) {
...
value hx_gl_texImage3D(value* args, int narg) {
    void* data = NULL;
    value buf = args[9];
    if (!val_is_null(buf)) data = get_vector<GLvoid>(buf, args[10]);
...
value hx_gl_texImage3DMultisample(value* args, int narg) {
...
value hx_gl_texParameterf(value target, value pname, value param) {
    glTexParameterf(val_get<int>(target), val_get<int>(pname), val_get<float>(param));
    return val_null;
}
value hx_gl_texParameteri(value target, value pname, value param) {
    glTexParameteri(val_get<int>(target), val_get<int>(pname), val_get<int>(param));
    return val_null;
}
value hx_gl_texSubImage1D(value* args, int narg) {
    glTexSubImage1D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), get_vector<GLvoid>(args[6], args[7]));
    return val_null;
}
value hx_gl_texSubImage2D(value* args, int narg) {
    glTexSubImage2D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), val_get<int>(args[6]), val_get<int>(args[7]), get_vector<GLvoid>(args[8], args[9]));
    return val_null;
}
value hx_gl_texSubImage3D(value* args, int narg) {
    glTexSubImage3D(val_get<int>(args[0]), val_get<int>(args[1]), val_get<int>(args[2]), val_get<int>(args[3]), val_get<int>(args[4]), val_get<int>(args[5]), val_get<int>(args[6]), val_get<int>(args[7]), val_get<int>(args[8]), val_get<int>(args[9]), get_vector<GLvoid>(args[10], args[11]));
    return val_null;
}
value hx_gl_transformFeedbackVaryings(value program, value varyings, value bufferMode) {
...
// ================================================================================================
#define UNIFORM1(N, T) \
    value hx_gl_uniform1##N(value loc, value v0) { \
...
UNIFORM1(ui, int);
#define UNIFORM2(N, T) \
    value hx_gl_uniform2##N(value loc, value v0, value v1) { \
...
UNIFORM2(ui, int);
#define UNIFORM3(N, T) \
    value hx_gl_uniform3##N(value loc, value v0, value v1, value v2) { \
...
UNIFORM3(ui, int);
#define UNIFORM4(N, T) \
    value hx_gl_uniform4##N(value loc, value v0, value v1, value v2, value v3) { \
...
#define UNIFORMF(N) \
    value hx_gl_uniform##N##fv(value loc, value cnt, value val, value off) { \
        glUniform##N##fv(val_get<int>(loc), val_get<int>(cnt)/N, get_vector<GLfloat>(val, off)); \
        return val_null; \
    } \
...
#define UNIFORMI(N, G, T) \
    value hx_gl_uniform##N##G##v(value loc, value val) { \
        T* buf = (T*)copy_ints(val); \
        glUniform##N##G##v(val_get<int>(loc), val_array_size(val)/N, buf); \
        delete[] buf; \
        return val_null; \
    } \
...
#define UNIFORMMAT(N, T) \
    value hx_gl_uniformMatrix##N##fv(value loc, value cnt, value transpose, value val, value off) { \
        glUniformMatrix##N##fv(val_get<int>(loc), val_get<int>(cnt)/T, val_get<bool>(transpose), get_vector<GLfloat>(val, off)); \
        return val_null; \
    } \
...
value hx_gl_uniformBlockBinding(value program, value ind, value bind) {
    glUniformBlockBinding(val_get<int>(program), val_get<int>(ind), val_get<int>(bind));
    return val_null;
}
value hx_gl_useProgram(value program) {
...
#define VERTEXATTRv(N, G) \
    value hx_gl_vertexAttrib##N##v(value index, value v, value off) { \
        glVertexAttrib##N##v(val_get<int>(index), get_vector<G>(v, off)); \
        return val_null; \
    } \
    DEFINE_PRIM(hx_gl_vertexAttrib##N##v, 3)
#define VERTEXATTRa(N, T, G) \
    value hx_gl_vertexAttrib##N##v(value index, value v) { \
...
#define VERTEXATTR1(N, T, G) \
    value hx_gl_vertexAttrib##N(value index, value v0) { \
...
#define VERTEXATTR2(N, T, G) \
    value hx_gl_vertexAttrib##N(value index, value v0, value v1) { \
...
#define VERTEXATTR3(N, T, G) \
    value hx_gl_vertexAttrib##N(value index, value v0, value v1, value v2) { \
...
#define VERTEXATTR4(N, T, G) \
    value hx_gl_vertexAttrib##N(value index, value v0, value v1, value v2, value v3) { \
...
value hx_gl_vertexAttribP1ui(value index, value type, value normalized, value value) {
    glVertexAttribP1ui(val_get<int>(index), val_get<int>(type), val_get<bool>(normalized), val_get<int>(value));
    return val_null;
}
value hx_gl_vertexAttribP2ui(value index, value type, value normalized, value value) {
    glVertexAttribP2ui(val_get<int>(index), val_get<int>(type), val_get<bool>(normalized), val_get<int>(value));
    return val_null;
}
value hx_gl_vertexAttribP3ui(value index, value type, value normalized, value value) {
    glVertexAttribP3ui(val_get<int>(index), val_get<int>(type), val_get<bool>(normalized), val_get<int>(value));
    return val_null;
}
value hx_gl_vertexAttribP4ui(value index, value type, value normalized, value value) {
...
value hx_gl_vertexAttribDivisor(value index, value divisor) {
    glVertexAttribDivisor(val_get<int>(index), val_get<int>(divisor));
    return val_null;
}
value hx_gl_vertexAttribPointer(value* args, int narg) {
...
value hx_gl_vertexAttribIPointer(value index, value size, value type, value stride, value offset) {
    glVertexAttribIPointer(val_get<int>(index), val_get<int>(size), val_get<int>(type), val_get<int>(stride), (GLvoid*)val_get<int>(offset));
    return val_null;
}
value hx_gl_viewport(value x, value y, value width, value height) {
...
// W
// ================================================================================================
value hx_gl_waitSync(value sync, value flags, value timeLow, value timeHigh) {
    val_check_kind(sync, k_Sync);
    GLsync syncVal = (GLsync)val_data(sync);
    GLuint64 val;
    ((int*)&val)[0] = val_get<int>(timeLow);
